...
export default function createBasicContext<Store extends Record<string, unknown>>(initialState: Store) {
  ...
  function useStoreData(): {
    get: () => Store;
    set: (value: Partial<Store>, direct?:any[]|null, update?:any) => void;
    ...
    const set = useCallback((value: Partial<Store>, direct:any[]|null = null, update:any = null) => {
  ...
  ): [SelectorOutput, (value: Partial<Store>, direct?:any[]|null, update?:any) => void] {
